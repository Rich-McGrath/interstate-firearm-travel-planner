...
import CarryWarningBanner from './components/CarryWarningBanner'
      ...
      <div className="app">
        ...
        <main className="app__main">
          ...
          {evaluation && trip && exportPayload && (
            <>
              {/* Destination carry warning — pinned above everything
                  else in the results so a "your permit isn't recognized
                  at the destination" finding lands first. Only renders
                  when the rule fires (permit + firearm transport +
                  destination recognition is 'no'). */}
              {carryWarning && <CarryWarningBanner warning={carryWarning} />}
